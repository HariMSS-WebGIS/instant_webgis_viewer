...
function generateQR() {
  ...
  // Try uploading to litterbox via corsproxy.io to bypass CORS / Origin: null blocks
  ...
  var proxyUrl = 'https://corsproxy.io/?url=' + encodeURIComponent(litterboxUrl);

  fetch(proxyUrl, {method: 'POST', body: fd1})
    ...
    .catch(function(){
      // Fallback 1: Direct upload to Litterbox
      fetch(litterboxUrl, {method: 'POST', body: fd1})
        ...
        .catch(function(){
          ...
          prog.textContent = 'Generating QR code (fallback)...';
